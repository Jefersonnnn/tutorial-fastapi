...
class TestListarPedidos:
    ...
    def test_quando_encontrar_pedido_deve_retornar_itens(self, cliente, sobreescreve_recuperar_itens_por_pedido):
        itens = [
            Item(sku='1', description="Item 1", image_url='https://url.com/img1', reference='ref1', quantity=1),
            Item(sku='2', description="Item 2", image_url='https://url.com/img2', reference='ref2', quantity=2),
        ]
